...
SQL_CONFIG["COMPACT_TRANSFORMER"] = """ SELECT
                                        ...
                                        FROM
                                            BASAWANAGUDI_210.ROAD_ID AS ROAD_ID
                                            LEFT JOIN BASAWANAGUDI_210.ISSUE_POINT AS RITIC ON ROAD_ID.FOOTPATH_SIDE = RITIC.FOOTPATH_SIDE
...
SQL_CONFIG["PARKING_SIGNAGE"] = """ WITH
                                        ...
                                        ROAD_ID_IS_PARKING_FEASIBLE AS (
                                            SELECT
                                                ...
                                                IS_PARKING_FEASIBLE
                                            FROM
                                                BASAWANAGUDI_210.POST_AUDIT_QUESTIONS PAQ
                                        ),
